/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘MyFavoriteCustomer.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity7Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>d4a1197a-608d-4d6e-8f5f-e3aea8c005ae</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>CityPairs!Input</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>False</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value>CityPairs</Value></QueryParameter><QueryParameter><Name>FilePath</Name><Value>" + _context.ResourceManager.GetValue("{CityPairs!Input.TablePath}") + "</Value></QueryParameter><QueryParameter><Name>SheetName</Name><Value>Input$</Value></QueryParameter><QueryParameter><Name>ContainsHeadersRow</Name><Value>True</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.DataExporterActivity9.InDirections.Add(bind_dir7);
            ...
            _flow.DataDisconnectActivity8.InDirections.Add(bind_dir8);
            ...
            this.DataCursorActivity11.InDirections.Add(bind_dir9);
            ...
            this.DataCursorActivity11_Policy.StepSize = 2;
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.CityPairs!Input.DepartureCity}</DepartureCity><ArrivalCity>{DataSource.CityPairs!Input.ArrivalCity}</ArrivalCity><FlightDate>2019-12-25T00:00:00-06:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            bind_dir10 = new BindDirection(this.DataCursorActivity11,binding_getter10,binding_setter10,BindTargetType.ToInProperty);
